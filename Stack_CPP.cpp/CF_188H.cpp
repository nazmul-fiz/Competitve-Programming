...
// Done it With Another Method and CF have restriction on Language , This Problem can be solved with ROCO language Only, 
// But i have done it with CPP //
e4{
   string s;
   cin>>s;
